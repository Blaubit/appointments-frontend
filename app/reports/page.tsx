...
export default function ReportsPage() {
  ...
  const topServices = [
    { name: "Consulta General", appointments: 89, revenue: 4450, percentage: 26 },
    { name: "Limpieza Dental", appointments: 67, revenue: 3350, percentage: 20 },
    { name: "Corte y Peinado", appointments: 54, revenue: 2700, percentage: 16 },
    { name: "Terapia Física", appointments: 43, revenue: 4300, percentage: 13 },
    { name: "Consulta Especializada", apartments: 38, revenue: 3800, percentage: 11 },
    { name: "Otros", appointments: 51, revenue: 2550, percentage: 14 },
  ]

  const topClients = [
    { name: "María González", appointments: 12, revenue: 1200, lastVisit: "2024-01-15" },
    { name: "Carlos Rodríguez", appointments: 8, revenue: 800, lastVisit: "2024-01-14" },
    { name: "Ana Martínez", appointments: 7, revenue: 875, lastVisit: "2024-01-13" },
    { name: "Luis Fernández", appointments: 6, revenue: 750, lastVisit: "2024-01-12" },
    { name: "Carmen López", appointments: 5, revenue: 625, lastVisit: "2024-01-11" },
  ]
  ...
  const maxAppointments = Math.max(...appointmentsByHour.map((item) => item.count))
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">Reportes y Análisis</h1>
              </div>
            </div>
                  ...
                  <div key={index} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xs text-gray-500">{data.appointments} citas</span>
                      </div>
            ...
            <CardContent>
              <div className="space-y-3">
                {appointmentsByHour.map((data, index) => (
                  <div key={index} className="flex items-center space-x-4">
                    <div className="w-16 text-sm font-medium text-gray-600 dark:text-gray-400">{data.hour}</div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm text-gray-600 dark:text-gray-400">{data.count} citas</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Ranking de servicios por número de citas</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {topServices.map((service, index) => (
                  <div key={index} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-500">{service.appointments} citas</span>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Clientes con mayor frecuencia de visitas</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {topClients.map((client, index) => (
                  <div key={index} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-500">{client.appointments} citas</span>
                        <span className="text-xs text-gray-400">Última: {client.lastVisit}</span>
                      </div>
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Tiempo Promedio por Cita</CardTitle>
              <Clock className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">45 min</div>
              <p className="text-xs text-muted-foreground">+2 min vs mes anterior</p>
            </CardContent>
          </Card>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-3 px-4 font-medium text-gray-900 dark:text-white">Métrica</th>
                    <th className="text-right py-3 px-4 font-medium text-gray-900 dark:text-white">Valor Actual</th>
                    <th className="text-right py-3 px-4 font-medium text-gray-900 dark:text-white">Mes Anterior</th>
                    <th className="text-right py-3 px-4 font-medium text-gray-900 dark:text-white">Cambio</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b">
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Ingresos Totales</td>
                  ...
                  <tr className="border-b">
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Total de Citas</td>
                  ...
                  <tr className="border-b">
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Nuevos Clientes</td>
                  ...
                  <tr className="border-b">
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Citas Canceladas</td>
                  ...
                  <tr>
                    <td className="py-3 px-4 text-gray-600 dark:text-gray-400">Ingreso Promedio por Cita</td>
