              ...
              <CardContent>
                <ScrollArea className="h-[600px] pr-4">
                  <div className="space-y-6">
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">1. Información que Recopilamos</h2>
                      <div className="space-y-3 text-muted-foreground">
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-4">
                          ...
                          <li>Contenido que compartes a través de nuestros servicios</li>
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">2. Cómo Utilizamos tu Información</h2>
                      <div className="space-y-3 text-muted-foreground">
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">3. Compartir Información</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                          No vendemos, intercambiamos ni transferimos tu información personal a terceros sin tu
                          consentimiento, excepto en las siguientes circunstancias:
                        </p>
                        <ul className="list-disc list-inside space-y-1 ml-4">
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">4. Seguridad de Datos</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">5. Tus Derechos</h2>
                      <div className="space-y-3 text-muted-foreground">
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">6. Contacto</h2>
                      <div className="space-y-3 text-muted-foreground">
            ...
            <Card>
              ...
              <CardContent>
                <ScrollArea className="h-[600px] pr-4">
                  <div className="space-y-6">
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">1. Aceptación de Términos</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                          Al acceder y utilizar esta aplicación, aceptas estar sujeto a estos términos de uso. Si no
                    ...
                    <section>
                      ...
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                          Nuestra aplicación proporciona [descripción de tu servicio]. Nos reservamos el derecho de
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">3. Cuentas de Usuario</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>Para utilizar ciertos aspectos del servicio, debes:</p>
                        <ul className="list-disc list-inside space-y-1 ml-4">
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">4. Uso Aceptable</h2>
                      <div className="space-y-3 text-muted-foreground">
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">5. Propiedad Intelectual</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                          El servicio y su contenido original, características y funcionalidad son y seguirán siendo
                          propiedad exclusiva de [Tu Empresa] y sus licenciantes.
                        </p>
                      </div>
                    </section>
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">6. Limitación de Responsabilidad</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                          En ningún caso seremos responsables por daños indirectos, incidentales, especiales,
                          consecuentes o punitivos, incluyendo pérdida de beneficios, datos, uso, buena voluntad u otras
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">7. Terminación</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                          Podemos terminar o suspender tu cuenta inmediatamente, sin previo aviso o responsabilidad, por
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">8. Cambios en los Términos</h2>
                      <div className="space-y-3 text-muted-foreground">
                        <p>
                    ...
                    <section>
                      <h2 className="text-2xl font-semibold mb-3 text-primary">9. Contacto</h2>
                      <div className="space-y-3 text-muted-foreground">
