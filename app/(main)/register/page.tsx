...
export default function RegisterPage() {
  ...
  const [userType, setUserType] = useState<"professional" | "client" | null>(
    null,
  );
              ...
              {currentStep === 2 && (
                <div className="space-y-6">
                  ...
                  {formData.businessType &&
                    commonServices[
                      formData.businessType as keyof typeof commonServices
                    ] && (
                      <div className="space-y-4">
                        <h4 className="font-medium text-gray-900 dark:text-white">
                    ...
                    <div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800 max-h-40 overflow-y-auto">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                          ...
                          <li>
                            Respetar los horarios y políticas de los
                            profesionales
                          </li>
                          <li>
