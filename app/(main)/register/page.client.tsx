...
export default function RegisterClient({ 
  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 2) {
      ...
      if ((formData.user.bio ?? "").trim().length > 0 && (formData.user.bio ?? "").trim().length < 10) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!adminRole) {
        setErrors({ submit: "No se pudo encontrar el rol de administrador. Contacta con soporte." })
        return
      }
      ...
      if (companyResponse.status !== 200 && companyResponse.status !== 201) {
        ...
        setErrors({ 
          submit: companyResponse.message || "Error al crear la empresa. Inténtalo de nuevo." 
        })
        return
      }
      ...
      if (bio.length === 0) {
        bio = "Administrador de empresa médica con experiencia en gestión y atención al paciente."
      ...
      if (userResponse.status !== 200 && userResponse.status !== 201) {
        ...
        setErrors({ 
          submit: userResponse.message || "Error al crear el usuario administrador. Inténtalo de nuevo." 
        })
        return
      }

      console.log("Usuario administrador creado exitosamente:", userResponse.data)
      ...
      setErrors({ submit: "Error inesperado al crear la cuenta. Inténtalo de nuevo." })
    } finally {
      setIsLoading(false)
    }
  }
          ...
          <CardHeader className="text-center space-y-4 px-4 sm:px-6">
            ...
            <div>
              ...
              <CardDescription className="text-base sm:text-lg text-muted-foreground mt-2 px-2">
                Registra tu empresa y comienza a gestionar citas de forma profesional
              </CardDescription>
            </div>
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white">{getStepTitle()}</h2>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 px-2">{getStepDescription()}</p>
            </div>
          </CardHeader>
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h4 className="font-medium text-gray-900 dark:text-white">Dirección de la Empresa</h4>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              company: { ...formData.company, postal_code: e.target.value },
                            })
                          }
                          placeholder="01001"
                        />
              ...
              {currentStep === 2 && (
                <div className="space-y-6">
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Cuenta de Administrador</h3>
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2 text-sm sm:text-base">Rol: Administrador de Empresa</h4>
                    <p className="text-xs sm:text-sm text-blue-800 dark:text-blue-400">
                      Tendrás acceso completo para gestionar usuarios, citas, servicios y configuraciones de la empresa.
                    </p>
                  </div>
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              user: { ...formData.user, confirmPassword: e.target.value },
                            })
                          }
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800 max-h-32 sm:max-h-40 overflow-y-auto">
                      <h4 className="font-medium mb-2 text-sm sm:text-base">Términos de Servicio para Empresas</h4>
                      <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 space-y-2">
                        ...
                        <ul className="list-disc list-inside space-y-1">
                          ...
                          <li>Gestionar responsablemente las citas de tus pacientes</li>
                    ...
                    <div className="p-4 border rounded-lg bg-gray-50 dark:bg-gray-800 max-h-32 sm:max-h-40 overflow-y-auto">
                      <h4 className="font-medium mb-2 text-sm sm:text-base">Política de Privacidad</h4>
                      <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 space-y-2">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="space-y-1 flex-1">
                        <Label htmlFor="acceptTerms" className="text-xs sm:text-sm font-medium cursor-pointer">
                          Acepto los términos y condiciones *
                        </Label>
                        <p className="text-xs text-gray-500">
                          Al marcar esta casilla, confirmas que has leído y aceptas nuestros términos de servicio y
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      />
                      <div className="space-y-1 flex-1">
                        <Label htmlFor="acceptMarketing" className="text-xs sm:text-sm font-medium cursor-pointer">
                          Recibir actualizaciones y ofertas especiales
                        </Label>
                        <p className="text-xs text-gray-500">
                          Mantente informado sobre nuevas funcionalidades y promociones
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between gap-3">
                    ...
                    <Button type="submit" disabled={isLoading || !acceptTerms} className="order-1 sm:order-2">
                      {isLoading ? (
                        <>
                ...
                <div className="text-center space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      ...
                      <p className="text-sm text-blue-800 dark:text-blue-400">{formData.company.name}</p>
                      <p className="text-xs text-blue-600 dark:text-blue-500 mt-1">
                        {companyTypes.find((t) => t.value === formData.company.companyType)?.label}
                      </p>
                    </div>
                    ...
                    <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                      ...
                      <p className="text-sm text-purple-800 dark:text-purple-400">{formData.user.fullName}</p>
                      <p className="text-xs text-purple-600 dark:text-purple-500 mt-1">Rol: Administrador de Empresa</p>
                    </div>
                  </div>

                  <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <h4 className="font-medium text-green-900 dark:text-green-300 mb-4 text-sm sm:text-base">¿Qué sigue?</h4>
