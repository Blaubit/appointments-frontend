...
import { Calendar, Mail, Lock, Eye, EyeOff, Clock, Stethoscope, ArrowLeft, Loader2, AlertCircle } from "lucide-react"
...
export default function LoginClient({ serverAction, serverMetadata }: LoginClientProps) {
  // Estados del cliente
        ...
        <div className="mt-6 text-center text-xs text-muted-foreground">
          ...
          {serverMetadata.environment === 'development' && (
            <div className="mt-2 text-xs opacity-50">
              v{serverMetadata.version} • {new Date(serverMetadata.timestamp).toLocaleTimeString()}
            </div>
          )}
        </div>
      </div>
